...
wn.title("Flappy BOB")
wn.bgcolor("purple")
wn.bgpic("C:/Users/onilp/Documents/snakepython/minecraft/minecraft/4dog.gif")
wn.setup(width=800, height=800)
wn.tracer(0)

wn.addshape(name="bird.gif" ,shape=None)

wn.addshape(name="3blackhole.gif" ,shape=None)
...
pipe1_top.shape("3blackhole.gif")
...
pipe1_bottom.shape("3blackhole.gif")
...
pipe2_top.shape("3blackhole.gif")
...
pipe2_bottom.shape("3blackhole.gif")
...
while True:
    ...
    if (player.xcor() + 10 > pipe1_top.xcor() - 30) and (player.xcor() - 10 < pipe1_top.xcor() + 30):
        if (player.ycor() + 10 > pipe1_top.ycor() - 180) or (player.ycor() - 10 < pipe1_bottom.ycor() + 180):
            pen.clear()
            pen.write("Game Over Good luck next time", move=False, align="center", font=("Courier", 16, "italic"))
            wn.update()
            time.sleep(3)
            # Reset score
            player.score = 0
    ...
    if pipe1_top.xcor() + 30 < player.xcor() - 10:
        ...
        pipe1_top.value = 0
        pen.clear()
        pen.write(player.score, move=False, align="center", font=("Courier", 32, "italic"))
    ...
    if (player.xcor() + 10 > pipe2_top.xcor() - 30) and (player.xcor() - 10 < pipe2_top.xcor() + 30):
        if (player.ycor() + 10 > pipe2_top.ycor() - 180) or (player.ycor() - 30 < pipe2_bottom.ycor() + 180):
            pen.clear()
            pen.write("Game Over Good luck next time", move=False, align="left", font=("Arial", 16, "normal"))
            wn.update()
            time.sleep(3)
            # Reset score
            player.score = 0
